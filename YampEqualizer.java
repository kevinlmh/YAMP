...
//                    }
//                }
                if(yampmain.getProgressBarChanged()) {
                    synchronizeEqualizer();
                    yampmain.setProgressBarChanged(false);
                }
	}
	...
	public void updateSliders(int[] gains) {
		if (gains != null) {
			for (int i = 0; i < gains.length; i++) {
				...
				sliders[i].setValue(maxGain - gainValue[i + 1]);
			}
		}
	}
	...
	public void synchronizeEqualizer() {
        ...
        public void loadPreset(int i) {
                switch(i) {
                    case 1: updateSliders(PRESET_NORMAL);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 2: updateSliders(PRESET_CLASSICAL);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 3: updateSliders(PRESET_CLUB);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 4: updateSliders(PRESET_DANCE);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 5: updateSliders(PRESET_FULLBASS);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 6: updateSliders(PRESET_FULLBASSTREBLE);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 7: updateSliders(PRESET_FULLTREBLE);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 8: updateSliders(PRESET_LAPTOP);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 9: updateSliders(PRESET_LIVE);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 10:updateSliders(PRESET_PARTY);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 11:updateSliders(PRESET_POP);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 12:updateSliders(PRESET_REGGAE);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 13:updateSliders(PRESET_ROCK);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    case 14:updateSliders(PRESET_TECHNO);
                            synchronizeEqualizer();
                            currentPreset=i;
                            break;
                    default: break;
...
//                        sliderLabels[i].setBounds(10+10*i, 100, 25, 25);
//                        add(sliderLabels[i]);
		}
	}
}
