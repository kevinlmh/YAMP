...
public class YampMain extends JFrame implements BasicPlayerListener {
	...
	private JMenuItem mntmAbout;
        ...
        /*Equalizer menu bar swing components*/
        private JMenu mnEqualizer;
        private JMenu mnDistribution;
        private JCheckBoxMenuItem mntmLinear;
        private JCheckBoxMenuItem mntmOver;
        private JMenu mnPresets;
        private JMenuItem mntmNormal;
        private JMenuItem mntmClassical;
        private JMenuItem mntmClub;
        private JMenuItem mntmDance;
        private JMenuItem mntmFullBass;
        private JMenuItem mntmFullBassTreble;
        private JMenuItem mntmFullTreble;
        private JMenuItem mntmLaptop;
        private JMenuItem mntmLive;
        private JMenuItem mntmParty;
        private JMenuItem mntmPop;
        private JMenuItem mntmReggae;
        private JMenuItem mntmRock;
        private JMenuItem mntmTechno;
        
        private JPanel labelPanel;
        private JLabel[] sliderLabels;
        private String[] sliderStrings = {"60", "170", "310", "600", "1K", "3K", "6K", "12K", "14K", "16K"};
        private int currentPreset=1;
        private boolean progressBarChanged=false;
...
//		System.out.println("progress : " + properties.toString());
	...
	public void setVolume(int percentage) {
        ...
        public void setProgressBarChanged(boolean bool) {
            progressBarChanged=bool;
        }
        
        public boolean getProgressBarChanged() {
...
//		tablemodel.addRow(rowdata);
	...
	public void initUI() {
		...
		mnView.add(mntmLyrics);
                ...
                mnEqualizer = new JMenu("Equalizer");
                menuBar.add(mnEqualizer);
                
                mnDistribution = new JMenu("Distribution");
                mnEqualizer.add(mnDistribution);
                
                mntmLinear = new JCheckBoxMenuItem("Linear");
                mntmLinear.setState(true);
		mntmLinear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(1);
				equalizer.setEqdist(1);
                                equalizer.loadPreset(currentPreset);
                                mntmOver.setState(false);
			}
		});
		mnDistribution.add(mntmLinear);
                
                mntmOver = new JCheckBoxMenuItem("Over");
		mntmOver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(1);
				equalizer.setEqdist(2);
                                equalizer.loadPreset(currentPreset);
                                mntmLinear.setState(false);
			}
		});
		mnDistribution.add(mntmOver);
                
                mnPresets = new JMenu("Presets");
                mnEqualizer.add(mnPresets);
                ...
                mnPresets.add(mntmNormal);
                
                mntmClassical = new JMenuItem("Classical");
                mntmClassical.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(2);
                                currentPreset=2;
                        }
                });
                mnPresets.add(mntmClassical);
                
                mntmClub = new JMenuItem("Club");
                mntmClub.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(3);
                                currentPreset=3;
                        }
                });
                mnPresets.add(mntmClub);
                
                mntmDance = new JMenuItem("Dance");
                mntmDance.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(4);
                                currentPreset=4;
                        }
                });
                mnPresets.add(mntmDance);
                
                mntmFullBass = new JMenuItem("Full Bass");
                mntmFullBass.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(5);
                                currentPreset=5;
                        }
                });
                mnPresets.add(mntmFullBass);
                
                mntmFullBassTreble = new JMenuItem("Full Bass Treble");
                mntmFullBassTreble.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(6);
                                currentPreset=6;
                        }
                });
                mnPresets.add(mntmFullBassTreble);
                
                mntmFullTreble = new JMenuItem("Full Treble");
                mntmFullTreble.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(7);
                                currentPreset=7;
                        }
                });
                mnPresets.add(mntmFullTreble);
                
                mntmLaptop = new JMenuItem("Laptop");
                mntmLaptop.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(8);
                                currentPreset=8;
                        }
                });
                mnPresets.add(mntmLaptop);
                
                mntmLive = new JMenuItem("Live");
                mntmLive.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(9);
                                currentPreset=9;
                        }
                });
                mnPresets.add(mntmLive);
                
                mntmParty = new JMenuItem("Party");
                mntmParty.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(10);
                                currentPreset=10;
                        }
                });
                mnPresets.add(mntmParty);
                
                mntmPop = new JMenuItem("Pop");
                mntmPop.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(11);
                                currentPreset=11;
                        }
                });
                mnPresets.add(mntmPop);
                
                mntmReggae = new JMenuItem("Reggae");
                mntmReggae.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(12);
                                currentPreset=12;
                        }
                });
                mnPresets.add(mntmReggae);
                
                mntmRock = new JMenuItem("Rock");
                mntmRock.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(13);
                                currentPreset=13;
                        }
                });
                mnPresets.add(mntmRock);
                
                mntmTechno = new JMenuItem("Techno");
                mntmTechno.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                equalizer.loadPreset(14);
                                currentPreset=14;
                        }
                });
                mnPresets.add(mntmTechno);
...
//		add(btnTogglePlaylist);
		...
		equalizer  = new YampEqualizer();
                equalizer.setMain(this);
                //equalizer.setLayout(new BorderLayout());
		equalizerwindow = new JFrame("Equalizer");
                equalizerwindow.setLayout(new BorderLayout());
		//equalizerwindow.setContentPane(equalizer);
                equalizerwindow.add(equalizer, BorderLayout.CENTER);
                labelPanel = new JPanel();
                sliderLabels = new JLabel[10];
                for (int i = 0; i<10; i++) {
                    sliderLabels[i] = new JLabel(" "+sliderStrings[i]+" ");
                    labelPanel.add(sliderLabels[i]);
                }
                equalizerwindow.add(labelPanel, BorderLayout.SOUTH);
		equalizerwindow.setSize(360,240);//400, 240
